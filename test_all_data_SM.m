...
only_copy_plots = 0;
extract_coordination_Metric_by_set = 0;
...
targ_dir = fullfile(filesep, 'Users', 'smoeller', 'DPZ', 'Projects', 'ProgressReportsAndPresentations', '20181103_SfN-Meeting_San_Diego', 'ANALYSES', '4Igor');
...
if ispc
    ...
    folder = fullfile(SCPDirs.SCP_DATA_BaseDir, 'SCP_DATA', 'ANALYSES', 'hms-beagle2', '2019', 'CoordinationCheck');
end
...
output_dir = fullfile(SCPDirs.SCP_DATA_BaseDir, 'SCP_DATA', 'ANALYSES', 'hms-beagle2', '2019', 'CoordinationCheck', 'Plots');
...
elmoNaiveCuriusConfederate_02.setName = 'ElmoNaiveCuriusConfederate_02';
elmoNaiveCuriusConfederate_02.filenames = {...
...
elmoNaiveCuriusConfederate_02.Captions = {...
    '20180802', ...
    '20180808', ...
    '20180810', ...
    '20180831', ...
...
elmoNaiveCuriusConfederate_redleft_80_20.setName = 'ElmoNaiveCuriusConfederate_redleft_80_20';
elmoNaiveCuriusConfederate_redleft_80_20.filenames = {...
...
elmoNaiveCuriusConfederate_redleft_80_20.Captions = {...
    '20180919', ...
    '20180920', ...
    '20180921', ...
    '20180925', ...
...
elmoNaiveCuriusConfederate_redleft_20_80.setName = 'ElmoNaiveCuriusConfederate_redleft_20_80';
elmoNaiveCuriusConfederate_redleft_20_80.filenames = {...
...
elmoNaiveCuriusConfederate_redleft_20_80.Captions = {...
    '20180927', ...
    '20180928', ...
    '20181010', ...
    '20181011', ...
...
CuriusAW.setName = 'CuriusAW';
CuriusAW.filenames = {...
    'DATA_20180911T144201.A_Curius.B_AW.SCP_01.triallog.A.Curius.B.AW_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180912T141843.A_Curius.B_AW.SCP_01.triallog.A.Curius.B.AW_IC_JointTrials.isOwnChoice_sideChoice', ...
    };
CuriusAW.Captions = {...
    '20180911', ...
    '20180912', ...
...
teslaElmoNaiveCNL.setName = 'TeslaElmoNaiveCNL';
teslaElmoNaiveCNL.filenames = {...
    'DATA_20180516T090940.A_Tesla.B_Elmo.SCP_01.triallog.A.Tesla.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180517T085104.A_Tesla.B_Elmo.SCP_01.triallog.A.Tesla.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180518T104104.A_Tesla.B_Elmo.SCP_01.triallog.A.Tesla.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180522T101558.A_Tesla.B_Elmo.SCP_01.triallog.A.Tesla.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
...
flaffusCuriusConfederateCNL.setName = 'flaffusCuriusConfederateCNL';
flaffusCuriusConfederateCNL.filenames = {...
    'DATA_20180418T143951.A_Flaffus.B_Curius.SCP_01.triallog.A.Flaffus.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180419T141311.A_Flaffus.B_Curius.SCP_01.triallog.A.Flaffus.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180424T121937.A_Flaffus.B_Curius.SCP_01.triallog.A.Flaffus.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180425T133936.A_Flaffus.B_Curius.SCP_01.triallog.A.Flaffus.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
...
flaffusCuriusConfederateCNL.Captions = {...
    '180418',...
    '180419', ...
    '180424', ...
    '180425', ...
...
Macaques_early.filenames = {...
    'DATA_20180516T090940.A_Tesla.B_Elmo.SCP_00.triallog.A_Tesla.B_Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180504T114516.A_Tesla.B_Flaffus.SCP_00.triallog.A_Tesla.B_Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180525T091512.A_Tesla.B_Curius.SCP_00.triallog.A_Tesla.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180605T091549.A_Curius.B_Elmo.SCP_00.triallog.A_Curius.B_Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20171108T140407.A_Magnus.B_Curius.SCP_00.triallog.A_Magnus.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20171019T132932.A_Flaffus.B_Curius.SCP_00.triallog.A_Flaffus.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20171129T100056.A_Magnus.B_Flaffus.SCP_00.triallog.A_Magnus.B_Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
    };
...
Macaques_late.filenames = {...
    'DATA_20180524T103704.A_Tesla.B_Elmo.SCP_00.triallog.A_Tesla.B_Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180509T122330.A_Tesla.B_Flaffus.SCP_00.triallog.A_Tesla.B_Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180531T104356.A_Tesla.B_Curius.SCP_00.triallog.A_Tesla.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180615T111344.A_Curius.B_Elmo.SCP_00.triallog.A_Curius.B_Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180214T171119.A_Magnus.B_Curius.SCP_00.triallog.A_Magnus.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20171107T131228.A_Flaffus.B_Curius.SCP_00.triallog.A_Flaffus.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180125T155742.A_Magnus.B_Flaffus.SCP_00.triallog.A_Magnus.B_Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
    };
...
ConfederatesMacaques_early.filenames = {...
    'DATA_20171206T141710.A_SM.B_Curius.SCP_00.triallog.A_SM.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180131T155005.A_SM.B_Flaffus.SCP_00.triallog.A_SM.B_Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180620T095959.A_JK.B_Elmo.SCP_01.triallog.A.JK.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180601T122747.A_Tesla.B_SM.SCP_01.triallog.A.Tesla.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ...
    };
...
ConfederatesMacaques_late.filenames = {...
    'DATA_20180423T162330.A_SM.B_Curius.SCP_00.triallog.A_SM.B_Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
    'DATA_20180228T132647.A_SM.B_Flaffus.SCP_00.triallog.A_SM.B_Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
    };
...
HumanV4_50_50_80_20.setName = 'Human_V4_50_50_80_20';
HumanV4_50_50_80_20.filenames = {...
...
CuriusLinus.setName = 'CuriusLinus';
CuriusLinus.filenames = {...
...
if (SCAN_ALL_DATASET)
    struct_set_cell = {ElmoSM, CuriusLinus, HumanV4_50_50_80_20, LinusElmoNaive, elmoNaiveCuriusConfederate_redleft_20_80, elmoNaiveCuriusConfederate_redleft_80_20, CuriusAW, elmoNaiveCuriusConfederate_02, teslaElmoNaive, teslaNaiveFlaffusConfederate, teslaNaiveCuriusConfederate, elmoNaiveCuriusConfederate, SMTesla, SMElmo, JKElmo, magnusCuriusNaive, magnusNaiveCuriusConfederate, flaffusCuriusNaive, flaffusCuriusConfederate, flaffusEC, SMCurius, SMCuriusBlock, TNCurius, SMFlaffus, SMFlaffusBlock, FlaffusSM, humanPair, humanPairBlocked, SMhumanBlocked, magnusFlaffusNaive};
    fileOfInterest = {[], [], [], [], [], [], [], [], [], [], [], [], [], [], 1, [], [], [], [], [], [], [], [], [], [], [], [], [], [], []};

    
%     struct_set_cell = {HumanV4_50_50_80_20, LinusElmoNaive, elmoNaiveCuriusConfederate_redleft_20_80, elmoNaiveCuriusConfederate_redleft_80_20, elmoNaiveCuriusConfederate_02, elmoNaiveCuriusConfederate};
%     fileOfInterest = {[] [], [], [], [], []};
% %    struct_set_cell = {humanPairBlocked, SMhumanBlocked, magnusFlaffusNaive};
% %    fileOfInterest = {[], [], []};
% 
%     struct_set_cell = {HumanV4_50_50_80_20, LinusElmoNaive};
%     fileOfInterest = {[], []};
% 
%     struct_set_cell = {ElmoSM, CuriusLinus};
%     fileOfInterest = {[], []};
...
if (process_CNL_retreat_2018_sets_only)
    struct_set_cell = {teslaElmoNaiveCNL, flaffusCuriusConfederateCNL};
    fileOfInterest = {[], []};
    opts.process_CNL_retreat_2018_sets_only = process_CNL_retreat_2018_sets_only;
end

if (only_copy_plots)
     struct_set_cell = {elmoNaiveCuriusConfederate_redleft_20_80, elmoNaiveCuriusConfederate_redleft_80_20, CuriusAW, elmoNaiveCuriusConfederate_02, teslaElmoNaiveCNL, flaffusCuriusConfederateCNL, teslaElmoNaive, teslaNaiveFlaffusConfederate, teslaNaiveCuriusConfederate, elmoNaiveCuriusConfederate, SMTesla, SMElmo, JKElmo, magnusCuriusNaive, magnusNaiveCuriusConfederate, flaffusCuriusNaive, flaffusCuriusConfederate, flaffusEC, SMCurius, SMCuriusBlock, TNCurius, SMFlaffus, SMFlaffusBlock, FlaffusSM, humanPair, humanPairBlocked, SMhumanBlocked, magnusFlaffusNaive};

    for i_set = 1 : length(struct_set_cell)
        current_set = struct_set_cell{i_set};
        current_setname = current_set.setName;
        outdir = fullfile(targ_dir, current_setname);
        if ~exist(outdir, 'dir')
            mkdir(outdir)
        end
        
        % loop over all files
        current_session_id_list = current_set.filenames;
        ...
        for i_stem = 1 : length(current_session_id_list)
            ...
            [status, message] = copyfile(fullfile(folder, src_sub_dir, [current_stem, '*']), [outdir, filesep]);
        end
    end
    return
end
...
if (extract_coordination_Metric_by_set)
    ...
    %This is the set list for Oxford2018/SfN2018
    struct_set_cell = {Humans, Macaques_early, Macaques_late, ConfederatesMacaques_early, ConfederatesMacaques_late, ConfederateTrainedMacaques};
    
    % load the ALL_SESSION_METRICS table
    
    
    % extract the subset of rows for the sesssons in each set
    
    % 
    for i_metric = 1 : length(metrics_to_extract_list)
        current_metric = metrics_to_extract_list{i_metric};
    end
end
...
if (process_sets_individually)
    ...
    for i_set = 1 : num_sets
        fnCreatePlots(folder, {struct_set_cell{i_set}.filenames}, {struct_set_cell{i_set}.Captions}, {struct_set_cell{i_set}.setName}, {fileOfInterest{i_set}}, close_figures_on_return, opts)
    end
else
    ...
    fnCreatePlots(folder, filename, fileCaption, setName, fileOfInterest, close_figures_on_return, opts)
end
...
function [] = fnCreatePlots(folder, filename, fileCaption, setName, fileOfInterest, close_figures_on_return, opts)
