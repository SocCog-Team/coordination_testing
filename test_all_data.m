...
if ispc
    cfg.folder = 'Y:\SCP_DATA\ANALYSES\PC1000\2018\CoordinationCheck';
else
    ...
    cfg.folder = fullfile(SCPDirs.SCP_DATA_BaseDir, 'SCP_DATA', 'ANALYSES', 'hms-beagle2', '2018', 'CoordinationCheck');
    output_folder = fullfile(SCPDirs.SCP_DATA_BaseDir, 'SCP_DATA', 'ANALYSES', 'hms-beagle2', '2018', 'CoordinationCheck', 'Plots2');
...
LinusElmoNaive.setName = 'LinusElmo_Naive';
...
SCAN_ALL_DATASET = 0;
if (SCAN_ALL_DATASET)
    dataset = {teslaElmoNaive, teslaNaiveFlaffusConfederate, teslaNaiveCuriusConfederate, elmoNaiveCuriusConfederate, SMTesla, SMElmo, JKElmo, magnusCuriusNaive, magnusNaiveCuriusConfederate, flaffusCuriusNaive, flaffusCuriusConfederate, flaffusEC, SMCurius, SMCuriusBlock, TNCurius, SMFlaffus, SMFlaffusBlock, FlaffusSM, humanNontransparentPair, humanTransparentPair, humanPairBlocked, SMhumanBlocked, magnusFlaffusNaive, LinusElmoNaive};
