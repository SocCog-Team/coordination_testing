...
for iSet = 1:nSet   
    ...
    for iPlot = 1:nPlot
        ...
        elseif (iPlot == 8)
            ...
            if (iPlot == 3)
                y = [miValueWhole{iSet, :}];
                signifIndex = logical([miSignifWhole{iSet, :}]);
                minY = 0;
                maxY = 1;
            ...
            elseif (iPlot == 4)
                ...
                signifIndex = logical([sideMIsignifWhole{iSet, :}]);
                minY = 0;
                maxY = 1;
...
hold on
for iSet = 1:nSet
    scatter([sideMIvalueWhole{iSet, :}], [miValueWhole{iSet, :}], sz, colorList(iSet, :),'filled');
end
hold off
axis([0.0, 1.5, 0, 1.0]);
...
legendHandle = legend(setName, 'location', 'NorthEast');
